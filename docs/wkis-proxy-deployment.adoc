...
Script liegt unter /opt/docker/rp-filter-update.sh. Muss mit Sudo Rechten ausgeführt werden.
...
Die folgende Tabelle dokumentiert die entityIDs der WPV Infrastruktur.
Die Metadaten der sonstigen Relying Parties sind dem Metadaten-Feed zu entnehmen.

.entiyIDs
|===
| Entity | entityID
| WKIS-Proxy Backend (Dev) | https://satosa.vnet/sp/proxy_backend.xml
| WKIS-Proxy Frontend (Dev) | https://satosa.vnet/idp_proxy.xml
| WKIS-Proxy Backend (QSS) | https://wkiswpv.qss.wko.at/sp/proxy_backend.xml
| WKIS-Proxy Frontend (QSS) | https://wkiswpv.wko.at/sp/proxy_backend.xml
| WKIS (QSS) | https://wkiswpv.wko.at/sp/proxy_backend.xml
| SP1 (QSS) | https://sp1.test.wpv.portalverbund.at/sp.xml

| WKIS-Proxy Backend (QSS) | https://wkiswpv.wko.at/sp/proxy_backend.xml
| WKIS-Proxy Frontend (Prod) | https://wkiswpv.wko.at/idp_proxy.xml
| WKIS (Prod) | http://wkis.wko.at/adfs/services/trust
| TestSP (Prod) | https://testsp.wpv.portalverbund.at/sp.xml
|===
...
Das Source-Repo von SATOSA ist derzeit ein Fork vom Upstream Projekt.
Issues werden beim Upstream-Projekt gemeldet.

Ausnahme:   Fehlermeldungen beim Start:

"ERROR:satosa.plugin_loader:_load_microservices:Unable to load request micro service .."

Diser Fehler kann ignoriert werden, und ist im Upstream-Projekt schon gefixt.
